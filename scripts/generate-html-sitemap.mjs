...
const labels={ru:['Основные страницы','Кейсы','Журнал','Услуги'],uk:['Основні сторінки','Кейси','Журнал','Послуги'],en:['Main pages','Cases','Journal','Services'],es:['Páginas principales','Casos','Revista','Servicios']};
