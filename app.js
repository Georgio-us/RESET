...
if (shepitAssets) {
  ...
  if (googleBlock) googleBlock.innerHTML = `<div class="google-analysis"><div class="google-analysis-top"><span>03 / GOOGLE ADS</span><span>05.06 — 03.08</span></div><figure class="google-account"><img src="shepit_assets/google_ads_general.png" alt="Обзор кампаний Google Ads SHEPIT HOUSE" /><figcaption>ОБЗОР АККАУНТА GOOGLE ADS</figcaption></figure><svg class="google-connectors" viewBox="0 0 1000 500" aria-hidden="true"><path d="M118 308H290V382H504"/><path d="M708 109V214H875"/><circle cx="290" cy="308" r="6"/><circle cx="708" cy="214" r="6"/></svg><div class="google-evidence"><figure><img src="shepit_assets/google_ads_keys.png" alt="Коммерческие ключевые слова Google Ads" /><figcaption>КОММЕРЧЕСКИЕ КЛЮЧЕВЫЕ СЛОВА</figcaption></figure><figure><img src="shepit_assets/google_ads_ad1.png" alt="Объявления Google Ads" /><figcaption>ГРУППЫ И АДАПТИВНЫЕ ОБЪЯВЛЕНИЯ</figcaption></figure></div><aside class="google-kpis"><div><span>CTR КАМПАНИИ</span><b>4.99%</b></div><div><span>ЛУЧШИЙ ЗАПРОС</span><b>7.59%</b><small>«Купити будинок в розстрочку»</small></div><div><span>ЛУЧШЕЕ ОБЪЯВЛЕНИЕ</span><b>7.52%</b></div></aside><div class="google-work"><span>ЧТО СДЕЛАЛИ</span><p>Исследование спроса · семантическое ядро · коммерческие ключевые слова · группы и адаптивные объявления · минус-слова · оптимизация CTR</p></div></div>`;
  const googleCopy = document.querySelector('#google-ads .case-story-copy');
  if (googleCopy && !googleCopy.querySelector('.google-key-results')) googleCopy.insertAdjacentHTML('beforeend', '<div class="google-key-results"><div><b>4.99%</b><span>средний CTR<br />Google Ads</span></div><div><b>7.59%</b><span>лучший коммерческий<br />поисковый запрос</span></div><div><b>7.52%</b><span>лучшее<br />объявление</span></div></div>');
  ...
  if (metaOptimizationLabel) metaOptimizationLabel.textContent = 'СТОИМОСТЬ ЛИДА СНИЖЕНА В 3 РАЗА';
  const metaCompare = metaOptimization?.querySelector('.meta-compare');
  if (metaCompare && !metaOptimization.querySelector('.meta-deltas')) metaCompare.insertAdjacentHTML('afterend', '<div class="meta-deltas"><span>−72% бюджета</span><b>↓</b><span>−67% стоимости лида</span></div>');
